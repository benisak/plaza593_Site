...
const handleClick = () => {
  ...
  return (
    ...
    >
      <div className="w-full bg-white px-4 pt-5 pb-6 shadow-[0_-2px_10px_rgba(0,0,0,0.08)] flex flex-col">
        {/* Comprar ahora */}
        <a
          href={whatsappUrl}
          target="_blank"
