...
export const publicProjectId = process.env.NEXT_PUBLIC_SANITY_PROJECT_ID as string;

export const dataset = process.env.SANITY_DATASET as string;

export const publicDataset = process.env.NEXT_PUBLIC_SANITY_DATASET as string;
